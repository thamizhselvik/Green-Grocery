...
const Vegetable = () => {
    ...
    useEffect(() => {
        const getProduct = async () => {
            const getApi = 'http://localhost:3000/api/vendor/getProductByCat/vegetable';
            const header = {
    ...
    const addCart = async (p) => {
        ...
        try {
            const res = await axios.post(postApi, { 'productId': p._id, 'quantity': 1 }, { headers: header });
